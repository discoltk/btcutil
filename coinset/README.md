...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/discoltk/btcutil/coinset)
...
```bash
$ go get -u github.com/discoltk/btcutil/coinset
```
